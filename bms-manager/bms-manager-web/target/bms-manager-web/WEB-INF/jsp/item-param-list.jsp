...
<table class="easyui-datagrid" id="itemParamList" title="商品列表" 
       ...
       url:'${pageContext.request.contextPath}/item/param/list',method:'post',pageSize:30,
       toolbar:itemParamListToolbar">
    <thead>
        <tr>
        	<th data-options="field:'ck',checkbox:true"></th>
        	<th data-options="field:'id'" width="8%">ID</th>
        	<th data-options="field:'itemCatId'" width="10%">商品类目ID</th>
<!--         	<th data-options="field:'itemCatName',width:100">  formatter:formatItemParamData 商品类目    </th> -->
            <th data-options="field:'paramData'" width="50%">规格(只显示分组名称)</th>
            <th data-options="field:'created',align:'center',formatter:TAOTAO.formatDateTime" width="15%">创建日期</th>
            <th data-options="field:'updated',align:'center',formatter:TAOTAO.formatDateTime" width="15%">更新日期</th>
        </tr>
    </thead>
</table>
